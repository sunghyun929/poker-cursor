...
export default function ChatWindow({ messages, onSendMessage, onClose, currentPlayerId }: ChatWindowProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9997]" style={{ background: 'rgba(0,0,0,0.1)' }} onClick={handleOverlayClick}>
      <Card className="fixed top-4 right-4 w-80 h-96 z-[9998] bg-black/90 backdrop-blur text-white border-gray-600" onClick={e => e.stopPropagation()}>
